...
namespace UnitTest.NotificationServiceReference {
    ...
    public interface INotificationService {
        ...
        System.Collections.Generic.List<UnitTest.NotificationServiceReference.Notification1> GetNotifications(int itemId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INotificationService/GetNotifications", ReplyAction="http://tempuri.org/INotificationService/GetNotificationsResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<UnitTest.NotificationServiceReference.Notification1>> GetNotificationsAsync(int itemId);
        ...
        System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog> GetNotificationLogs(int userId, System.DateTime startTime, System.DateTime endTime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INotificationService/GetNotificationLogs", ReplyAction="http://tempuri.org/INotificationService/GetNotificationLogsResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog>> GetNotificationLogsAsync(int userId, System.DateTime startTime, System.DateTime endTime);
        ...
        System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog> GetNotificationLog(int userId, int itemId, System.DateTime startTime, System.DateTime endTime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INotificationService/GetNotificationLog", ReplyAction="http://tempuri.org/INotificationService/GetNotificationLogResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog>> GetNotificationLogAsync(int userId, int itemId, System.DateTime startTime, System.DateTime endTime);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface INotificationServiceChannel : UnitTest.NotificationServiceReference.INotificationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class NotificationServiceClient : System.ServiceModel.ClientBase<UnitTest.NotificationServiceReference.INotificationService>, UnitTest.NotificationServiceReference.INotificationService {
        ...
        public System.Collections.Generic.List<UnitTest.NotificationServiceReference.Notification1> GetNotifications(int itemId) {
            return base.Channel.GetNotifications(itemId);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<UnitTest.NotificationServiceReference.Notification1>> GetNotificationsAsync(int itemId) {
        ...
        public System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog> GetNotificationLogs(int userId, System.DateTime startTime, System.DateTime endTime) {
            return base.Channel.GetNotificationLogs(userId, startTime, endTime);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog>> GetNotificationLogsAsync(int userId, System.DateTime startTime, System.DateTime endTime) {
            return base.Channel.GetNotificationLogsAsync(userId, startTime, endTime);
        }
        
        public System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog> GetNotificationLog(int userId, int itemId, System.DateTime startTime, System.DateTime endTime) {
            return base.Channel.GetNotificationLog(userId, itemId, startTime, endTime);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<UnitTest.NotificationServiceReference.NotificationLog>> GetNotificationLogAsync(int userId, int itemId, System.DateTime startTime, System.DateTime endTime) {
